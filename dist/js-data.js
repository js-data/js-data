...
(function (global, factory) {
  ...
  var utils = {
      ...
      extend: function extend(props, classProps) {
          ...
          if (obj.setPrototypeOf) {
              ...
              _subClass.__proto__ = superClass;
          } else {
       ...
       * @ignore
       */
      hidePrototypeMethods: function hidePrototypeMethods(ctor) {
          var descriptors = {};
       ...
       * @ignore
       */
      logify: function logify(target, defaultNamespace) {
          utils.addHiddenPropsToTarget(target, {
              ...
              log: function log(level) {
                  ...
                  var prefix = level.toUpperCase() + ': (' + (this.name || defaultNamespace) + ')';
                  if (console[level]) {
                      var _console;
   ...
   */
  Query.extend = utils$1.extend;
  utils$1.hidePrototypeMethods(Query);
  ...
  utils$1.hidePrototypeMethods(Index);
  ...
  var Collection = function () {
      ...
      babelHelpers.createClass(Collection, [{
          ...
          key: 'createIndex',
          value: function createIndex(name, fieldList, opts) {
              var self = this;
          ...
          key: 'updateIndex',
          value: function updateIndex(record, opts) {
              opts || (opts = {});
   ...
   */
  Collection.extend = utils$1.extend;
  /**
   * TODO
   *
   * @name Collection#on
   ...
   * @param {...*} [arg] TODO
   */
  utils$1.eventify(Collection.prototype, function () {
      return this._listeners;
  }, function (value) {
      this._listeners = value;
  });
  utils$1.hidePrototypeMethods(Collection);
  ...
  var Record = function () {
      ...
      babelHelpers.createClass(Record, [{
          key: '_set',
          value: function _set(prop, value) {}
      }, {
          key: '_get',
          value: function _get(prop) {}
      }, {
          key: '_unset',
          value: function _unset(prop) {}
          /**
           * TODO
           *
           * @name Record#_mapper
          ...
          key: 'loadRelations',
          value: function loadRelations(relations, opts) {
              var op = void 0;
              var self = this;
              var mapper = self._mapper();
              var relationList = mapper.relationList || [];
  ...
  utils$1.hidePrototypeMethods(Record);
  ...
  var Schema = function () {
      function Schema(definition) {
          babelHelpers.classCallCheck(this, Schema);
      ...
      babelHelpers.createClass(Schema, [{
          key: 'apply',
          value: function apply(target, opts) {
              opts || (opts = {});
  ...
  var Mapper = function () {
      ...
      babelHelpers.createClass(Mapper, [{
          ...
          key: 'belongsTo',
          value: function belongsTo(relatedMapper, opts) {
          ...
          key: 'createMany',
          value: function createMany(records, opts) {
              var op = void 0,
                  adapter = void 0;
              var self = this;
              // Default values for arguments
          ...
          key: 'hasMany',
          value: function hasMany(relatedMapper, opts) {
          ...
          key: 'hasOne',
          value: function hasOne(relatedMapper, opts) {
          ...
          key: 'toJSON',
          value: function toJSON(record, opts) {
              var self = this;
              opts || (opts = {});
   ...
   * @method
   */
  utils$1.logify(Mapper.prototype, 'Mapper');
  /**
   ...
   */
  utils$1.eventify(Mapper.prototype, function () {
      return this._listeners;
  }, function (value) {
      this._listeners = value;
  });
  utils$1.hidePrototypeMethods(Mapper);
   ...
   */
  Container.extend = utils$1.extend;
  var toAdd = {};
  ...
  utils$1.addHiddenPropsToTarget(Container.prototype, toAdd);
  utils$1.hidePrototypeMethods(Container);
  ...
  var LinkedCollection = Collection.extend({
      ...
      constructor: function constructor(records, opts) {
          ...
          utils$1.getSuper(self).call(self, records, opts);
   ...
   */
  utils$1.hidePrototypeMethods(LinkedCollection);
   ...
   */
  /* tslint:disable:variable-name */
  var DataStore = function (_Container) {
      babelHelpers.inherits(DataStore, _Container);
      ...
      function DataStore(opts) {
          ...
          var _this = babelHelpers.possibleConstructorReturn(this, Object.getPrototypeOf(DataStore).call(this, opts));

          var self = _this;
          utils$1.classCallCheck(self, DataStore);
          utils$1.getSuper(self).call(self, opts);
      ...
      babelHelpers.createClass(DataStore, [{
          key: '_callSuper',
          value: function _callSuper(method) {
              for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
                  args[_key - 1] = arguments[_key];
              }

              return babelHelpers.get(Object.getPrototypeOf(DataStore.prototype), method, this).apply(this, args);
          }
          /**
           * TODO
           *
          ...
          key: '_end',
          value: function _end(name, data, opts) {
              if (opts.raw) {
          ...
          key: 'create',
          value: function create(name, record, opts) {
              var self = this;
              opts || (opts = {});
          ...
          key: 'cachedFind',
          value: function cachedFind(name, id, opts) {
              return this.get(name, id, opts);
          }
      }, {
          key: 'cachedFindAll',
          value: function cachedFindAll(name, query, opts) {
              var self = this;
          ...
          key: 'update',
          value: function update(name, id, record, opts) {
              var self = this;
              opts || (opts = {});
          ...
          key: 'updateAll',
          value: function updateAll(name, query, props, opts) {
              var self = this;
              opts || (opts = {});
          ...
          key: 'updateMany',
          value: function updateMany(name, records, opts) {
              var self = this;
              opts || (opts = {});
  ...
  methods.eject = function () {
      return this.remove.apply(this, arguments);
  };
  methods.ejectAll = function () {
      return this.removeAll.apply(this, arguments);
  };
  utils$1.logify(DataStore.prototype, 'DataStore');
  utils$1.addHiddenPropsToTarget(DataStore.prototype, methods);
  utils$1.hidePrototypeMethods(DataStore);
