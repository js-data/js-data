...
*/
(function (factory) {
  typeof define === 'function' && define.amd ? define('js-data', factory) :
  factory();
}((function () { 'use strict';
   ...
   * @type {Constructor}
   */
  var LinkedCollection_1 = require("./LinkedCollection");
   ...
   * @type {Constructor}
   */
  var SimpleStore_1 = require("./SimpleStore");
