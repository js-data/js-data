...
test('should find', async (t) => {
  ...
  t.is(typeof t.context.store._completedQueries.user[id], 'number')
...
test('should return pending query', async (t) => {
  ...
  t.is(callCount, 1, 'find should have been called once')
  t.context.objectsEqual(users[0], props, 'user should have been found')
  t.context.objectsEqual(users[1], props, 'user should have been found')
