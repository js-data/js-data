...
test('should findAll', async (t) => {
  ...
  t.context.objectsEqual(users, props, 'users should have been found')
  t.ok(users[0] instanceof t.context.User.recordClass, 'user is a record')
  t.context.objectsEqual(await t.context.store.findAll('user', query), users, 'should return the cached users')
  t.is(callCount, 1, 'findAll should have been called once')
  t.context.objectsEqual(await t.context.store.findAll('user', query, { force: true }), props, 'should make a new query')
  t.is(callCount, 2, 'findAll should have been called twice')
  t.context.objectsEqual(await t.context.store.findAll('user', query), props, 'should return the cached users')
  t.is(callCount, 2, 'findAll should have been called twice')
})
test('should return pending query', async (t) => {
  ...
  t.is(callCount, 1, 'findAll should have been called once')
  t.context.objectsEqual(results[0], props, 'users should have been found')
  t.context.objectsEqual(results[1], props, 'users should have been found')
