...
test.skip('should add property accessors to prototype of target and allow relation re-assignment (foreignKeys)', (t) => {
  ...
  t.context.objectsEqual(t, foo.barCollection, [])
  t.context.objectsEqual(t, foo2.barCollection, [])
  const bars = Bar.inject([{ fooId: 1, id: 1 }])
  const bars2 = Bar.inject([{ fooId: 2, id: 2 }])
  t.context.objectsEqual(t, foo.barCollection, bars)
  t.context.objectsEqual(t, foo2.barCollection, bars2)
  foo.barCollection = bars2
  foo2.barCollection = bars
  t.context.objectsEqual(t, foo2.barCollection, bars)
  t.context.objectsEqual(t, foo.barCollection, bars2)
})
...
test.skip('should add property accessors to prototype of target and allow relation re-assignment (foreignKeys)', (t) => {
  ...
  t.context.objectsEqual(t, foo.barCollection, bars)
  t.context.objectsEqual(t, foo2.barCollection, bars2)
  t.context.objectsEqual(t, foo3.barCollection, [])
  foo.barCollection = bars2
  foo2.barCollection = bars
  foo3.barCollection = bars3
  t.context.objectsEqual(t, foo2.barCollection, bars.concat(bars2))
  t.context.objectsEqual(t, foo.barCollection, bars.concat(bars2))
  t.context.objectsEqual(t, foo3.barCollection, bars3)
  t.context.objectsEqual(t, bars[0].foo_ids, [1, 2])
  t.context.objectsEqual(t, bars2[0].foo_ids, [2, 1])
