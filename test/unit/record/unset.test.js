export function init () {
  describe('#unset', function () {
    it('should be an instance function', function () {
      const Test = this
      Test.assert.isFunction(Test.JSData.Model.prototype.unset)
      ...
      Test.assert.isFunction(User.prototype.unset)
      Test.assert.isFunction(User2.prototype.unset)
      Test.assert.isTrue(Test.JSData.Model.prototype.unset === User.prototype.unset)
      Test.assert.isTrue(Test.JSData.Model.prototype.unset === User2.prototype.unset)
      Test.assert.isTrue(User.prototype.unset === User2.prototype.unset)
      Test.assert.isTrue(User2.prototype.unset === User3.prototype.unset)
    })
